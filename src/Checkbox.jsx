...
function Checkbox({checked=false, onClick}){
    ...
    return (
        <div onClick={onClick} className="checkbox">
            {!checked ? (
                <svg className="unchecked" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                ...
                <svg className="checked" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
    ...
    //             {/* <FontAwesomeIcon icon={SolidSquare} /> */}
    ...
    //             {/* <FontAwesomeIcon icon={RegularSquare} /> */}
